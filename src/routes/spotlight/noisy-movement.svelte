<script context="module">
  export function preload({ path, params, query }) {
    return this.fetch(
      `https://api.freshair.radio/public/shows/society-spotlight`
    )
      .then((r) => r.json())
      .then((show) => ({
        show,
        episode: show.episodes.find(
          (e) => e.identifier === "e06c25f5-a45b-497f-9834-2e70e558eadf"
        )
      }));
  }
</script>
...
<img
  ...
  src={`https://cdn.freshair.radio/spotlight/noisy.png`} />
<div
  ...
  <Play {show} {episode} />
  <span
    class="text-xl font-thin text-black mx-auto text-center block mb-4">or</span>
  <div class="max-w-xl mx-auto flex flex-wrap gap-2 justify-center">
    <a
      href="https://open.spotify.com/episode/7LKJsiObxRsnpS6Sw0q3Ou"
      class="inline-block">
    ...
    <a
      ...
      <img src="/overcast.svg" class="h-8 w-8 inline-block align-middle" /><span
        class="inline-block text-xl font-thin align-middle ml-2 text-white mr-1">Overcast</span></a>
